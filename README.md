...
- 🔨 [NSwag](https://github.com/RicoSuter/NSwag) and [NJsonSchema](https://github.com/RicoSuter/NJsonSchema): The Swagger/OpenAPI toolchain for .NET, ASP.NET Core and TypeScript. There is my own Visual Studio extension to generate OpenAPI (Swagger) web service reference - [Unchase.OpenAPI.Connectedservice](https://github.com/unchase/Unchase.OpenAPI.Connectedservice).
